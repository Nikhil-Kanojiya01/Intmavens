        ...
        <div className="header-content">
          ...
          >
            <ul>
              ...
              <li
                className={`dropdown ${
                  openDropdowns.has("services") ? "dropdown--open" : ""
                }`}
              >
                <span
                ...
                <ul className="dropdown-menu">
                  ...
                  <li>
                    <Link
                      to="/services/hybrid-cloud-integration"
                      onClick={closeMobileMenu}
                    >
                  ...
                  <li>
                    <Link
                      to="/services/data-enablement-services"
                      onClick={closeMobileMenu}
                    >
                  ...
                  <li
                    className={`dropdown ${
                      openDropdowns.has("biztalk") ? "dropdown--open" : ""
                    }`}
                  >
                    <span
                      className="dropdown-link services-style"
                    ...
                    <ul className="dropdown-menu">
                      <li>
                        <Link
                          to="/services/biztalk-azureintegrationservices-ais"
                          onClick={closeMobileMenu}
                        >
                      ...
                      <li>
                        <Link
                          to="/services/biztalk-health-check"
                          onClick={closeMobileMenu}
                        >
                      ...
                      <li>
                        <Link
                          to="/services/biztalk-modernization-assessment"
                          onClick={closeMobileMenu}
                        >
              ...
              <li
                className={`dropdown dropdown--manual ${
                  openDropdowns.has("resources") ? "dropdown--open" : ""
                }`}
              >
                <span
                  className="dropdown-link"
                ...
                <ul className="dropdown-menu">
                  <li>
                    <Link to="/resources/blogs" onClick={closeMobileMenu}>
                      Blogs
                    </Link>
                  </li>
                  <li>
