	...
	return (
		<div className="service-page">
			...
			<section className="service-content section--sm">
				<div className="container">
					<div className="u-text-center">
						<h2 className="service-section__title center animate-slide-up-title">Objectives</h2>
						<p className="service-hero__subtitle animate-slide-up-delay-1" style={{ maxWidth: '800px', margin: '0 auto' }}>
			...
			<section className="service-content section--light section--sm">
				<div className="container">
					<div className="u-text-center">
						<h2 className="service-section__title center animate-slide-up-title">How it works?</h2>
			...
			<section className="service-content section--sm">
				<div className="container">
					<div className="u-text-center">
						<h2 className="service-section__title center animate-slide-up-title">Timelines</h2>
